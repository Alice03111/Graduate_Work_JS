...
let deadline = new Date(Date.parse(new Date()) + 17 * 24 * 60 * 60 * 1000);
let deadline2 = new Date(Date.parse(new Date()) + 8 * 24 * 60 * 60 * 1000);
let deadline3 = new Date(Date.parse(new Date()) + 10 * 24 * 60 * 60 * 1000);
let deadline4 = new Date(Date.parse(new Date()) + 5 * 24 * 60 * 60 * 1000);
let deadline5 = new Date(Date.parse(new Date()) + 25 * 24 * 60 * 60 * 1000);
